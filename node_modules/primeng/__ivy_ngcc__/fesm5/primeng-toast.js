...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r552); var ctx_r551 = ɵngcc0.ɵɵnextContext(); return ctx_r551.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r552); var ctx_r553 = ɵngcc0.ɵɵnextContext(); return ctx_r553.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
function ToastItem_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(3, _c1, ctx_r549.message.severity == "info", ctx_r549.message.severity == "warn", ctx_r549.message.severity == "error", ctx_r549.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r549.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r549.message.detail);
} }
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r559); var ctx_r558 = ɵngcc0.ɵɵnextContext(); return ctx_r558.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r559); var ctx_r560 = ɵngcc0.ɵɵnextContext(); return ctx_r560.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var msg_r556 = ctx.$implicit;
    var i_r557 = ctx.index;
    var ctx_r555 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r556)("index", i_r557)("template", ctx_r555.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r555.showTransformOptions)("hideTransformOptions", ctx_r555.hideTransformOptions)("showTransitionOptions", ctx_r555.showTransitionOptions)("hideTransitionOptions", ctx_r555.hideTransitionOptions);
} }
