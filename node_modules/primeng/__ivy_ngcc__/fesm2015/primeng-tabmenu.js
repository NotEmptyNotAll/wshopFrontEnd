...
function TabMenu_li_3_a_1_ng_container_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r111 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("ngClass", item_r111.icon);
} }
function TabMenu_li_3_a_1_ng_container_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r111 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r111.label);
} }
function TabMenu_li_3_a_1_ng_container_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 17);
} if (rf & 2) {
    const item_r111 = ɵngcc0.ɵɵnextContext(3).$implicit;
    ɵngcc0.ɵɵproperty("innerHTML", item_r111.label, ɵngcc0.ɵɵsanitizeHtml);
} }
function TabMenu_li_3_a_1_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const _r119 = ɵngcc0.ɵɵreference(4);
    const item_r111 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r111.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r111.escape !== false)("ngIfElse", _r119);
} }
...
function TabMenu_li_3_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TabMenu_li_3_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r126); const item_r111 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r125 = ɵngcc0.ɵɵnextContext(); return ctx_r125.itemClick($event, item_r111); });
    ...
    const item_r111 = ctx_r128.$implicit;
    const i_r112 = ctx_r128.index;
    const ctx_r113 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r111.url, ɵngcc0.ɵɵsanitizeUrl)("tabindex", item_r111.disabled ? null : "0")("target", item_r111.target)("title", item_r111.title)("id", item_r111.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r113.itemTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r113.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c2, item_r111, i_r112));
} }
...
function TabMenu_li_3_a_2_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r111.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r111.escape !== false)("ngIfElse", _r133);
} }
...
function TabMenu_li_3_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TabMenu_li_3_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r140); const item_r111 = ɵngcc0.ɵɵnextContext().$implicit; const ctx_r139 = ɵngcc0.ɵɵnextContext(); return ctx_r139.itemClick($event, item_r111); });
    ...
    const item_r111 = ctx_r142.$implicit;
    const i_r112 = ctx_r142.index;
    const ctx_r114 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r111.routerLink)("queryParams", item_r111.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", item_r111.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(17, _c3))("fragment", item_r111.fragment)("queryParamsHandling", item_r111.queryParamsHandling)("preserveFragment", item_r111.preserveFragment)("skipLocationChange", item_r111.skipLocationChange)("replaceUrl", item_r111.replaceUrl)("state", item_r111.state);
    ɵngcc0.ɵɵattribute("tabindex", item_r111.disabled ? null : "0")("target", item_r111.target)("title", item_r111.title)("id", item_r111.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r114.itemTemplate);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r114.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(18, _c2, item_r111, i_r112));
} }
...
function TabMenu_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction3(5, _c4, item_r111.disabled, ctx_r109.activeItem == item_r111, item_r111.visible === false));
    ɵngcc0.ɵɵattribute("aria-selected", ctx_r109.activeItem == item_r111)("aria-expanded", ctx_r109.activeItem == item_r111);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r111.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r111.routerLink);
} }
class TabMenu {
