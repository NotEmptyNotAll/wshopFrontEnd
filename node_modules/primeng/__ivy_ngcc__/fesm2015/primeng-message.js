...
function UIMessage_div_0_div_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("innerHTML", ctx_r39.text, ɵngcc0.ɵɵsanitizeHtml);
} }
function UIMessage_div_0_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r36.escape);
} }
function UIMessage_div_0_ng_template_3_span_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r40.text);
} }
function UIMessage_div_0_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", ctx_r38.escape);
} }
...
function UIMessage_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap(ctx_r35.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", ctx_r35.style)("ngClass", ɵngcc0.ɵɵpureFunction5(7, _c0, ctx_r35.severity === "info", ctx_r35.severity === "warn", ctx_r35.severity === "error", ctx_r35.severity === "success", ctx_r35.text == null));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r35.icon);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r35.escape)("ngIfElse", _r37);
} }
class UIMessage {
    constructor() {
        this.escape = true;
