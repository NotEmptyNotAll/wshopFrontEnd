...
function VirtualScroller_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r334.headerTemplate);
} }
...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const i_r341 = ctx.index;
    const c_r342 = ctx.count;
    const f_r343 = ctx.first;
    const l_r344 = ctx.last;
    const e_r345 = ctx.even;
    const o_r346 = ctx.odd;
    const ctx_r337 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c0, ctx_r337.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r340 ? ctx_r337.itemTemplate : ctx_r337.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c1, item_r340, i_r341, c_r342, f_r343, l_r344, e_r345, o_r346));
} }
...
function VirtualScroller_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r338.footerTemplate);
} }
