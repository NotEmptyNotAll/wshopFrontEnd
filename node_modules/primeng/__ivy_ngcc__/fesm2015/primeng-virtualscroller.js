...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r479 = ctx.$implicit;
    const i_r480 = ctx.index;
    const c_r481 = ctx.count;
    const f_r482 = ctx.first;
    const l_r483 = ctx.last;
    const e_r484 = ctx.even;
    const o_r485 = ctx.odd;
    const ctx_r477 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c0, ctx_r477.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r479 ? ctx_r477.itemTemplate : ctx_r477.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c1, item_r479, i_r480, c_r481, f_r482, l_r483, e_r484, o_r485));
} }
