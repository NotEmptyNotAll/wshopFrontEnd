...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r256 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r256.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r256 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r256.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r256.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r256 = ctx_r266.$implicit;
    const i_r257 = ctx_r266.index;
    const ctx_r261 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r261.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r256, i_r257));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r268); const option_r256 = ctx.$implicit; const i_r257 = ctx.index; const ctx_r267 = ɵngcc0.ɵɵnextContext(); return ctx_r267.onItemClick($event, option_r256, i_r257); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r268); const option_r256 = ctx.$implicit; const i_r257 = ctx.index; const ctx_r269 = ɵngcc0.ɵɵnextContext(); return ctx_r269.onItemClick($event, option_r256, i_r257); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r268); const ctx_r270 = ɵngcc0.ɵɵnextContext(); return ctx_r270.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r268); const ctx_r271 = ɵngcc0.ɵɵnextContext(); return ctx_r271.onBlur($event); });
    ...
    const _r260 = ɵngcc0.ɵɵreference(4);
    const ctx_r255 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r256.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r255.isSelected(option_r256), ctx_r255.disabled || option_r256.disabled, _r258 == ctx_r255.focusedItem, option_r256.icon != null, option_r256.icon && !option_r256.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r255.isSelected(option_r256))("title", option_r256.title)("aria-label", option_r256.label)("tabindex", ctx_r255.tabindex)("aria-labelledby", ctx_r255.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r255.itemTemplate)("ngIfElse", _r260);
} }
