...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r102.handleValues[0] + "%", ctx_r102.handleValues[1] - ctx_r102.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r103.handleValues[0] + "%", ctx_r103.handleValues[1] - ctx_r103.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r104.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r105.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r110 = ɵngcc0.ɵɵnextContext(); return ctx_r110.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r112 = ɵngcc0.ɵɵnextContext(); return ctx_r112.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r113 = ɵngcc0.ɵɵnextContext(); return ctx_r113.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r114 = ɵngcc0.ɵɵnextContext(); return ctx_r114.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r115 = ɵngcc0.ɵɵnextContext(); return ctx_r115.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r106 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r106.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r106.orientation == "horizontal" ? ctx_r106.handleValue + "%" : null, ctx_r106.orientation == "vertical" ? ctx_r106.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r106.disabled ? null : ctx_r106.tabindex)("aria-valuemin", ctx_r106.min)("aria-valuenow", ctx_r106.value)("aria-valuemax", ctx_r106.max)("aria-labelledby", ctx_r106.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r117 = ɵngcc0.ɵɵnextContext(); return ctx_r117.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r119 = ɵngcc0.ɵɵnextContext(); return ctx_r119.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r120 = ɵngcc0.ɵɵnextContext(); return ctx_r120.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r121 = ɵngcc0.ɵɵnextContext(); return ctx_r121.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r118); const ctx_r122 = ɵngcc0.ɵɵnextContext(); return ctx_r122.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r107 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r107.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r107.rangeStartLeft, ctx_r107.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r107.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r107.disabled ? null : ctx_r107.tabindex)("aria-valuemin", ctx_r107.min)("aria-valuenow", ctx_r107.value ? ctx_r107.value[0] : null)("aria-valuemax", ctx_r107.max)("aria-labelledby", ctx_r107.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r125 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 7, 9);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r125); const ctx_r124 = ɵngcc0.ɵɵnextContext(); return ctx_r124.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r125); const ctx_r126 = ɵngcc0.ɵɵnextContext(); return ctx_r126.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r125); const ctx_r127 = ɵngcc0.ɵɵnextContext(); return ctx_r127.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r125); const ctx_r128 = ɵngcc0.ɵɵnextContext(); return ctx_r128.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r125); const ctx_r129 = ɵngcc0.ɵɵnextContext(); return ctx_r129.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r108 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r108.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r108.rangeEndLeft, ctx_r108.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r108.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r108.disabled ? null : ctx_r108.tabindex)("aria-valuemin", ctx_r108.min)("aria-valuenow", ctx_r108.value ? ctx_r108.value[1] : null)("aria-valuemax", ctx_r108.max)("aria-labelledby", ctx_r108.ariaLabelledBy);
} }
