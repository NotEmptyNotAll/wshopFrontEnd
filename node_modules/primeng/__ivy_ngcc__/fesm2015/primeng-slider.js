...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r272.handleValues[0] + "%", ctx_r272.handleValues[1] - ctx_r272.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r273.handleValues[0] + "%", ctx_r273.handleValues[1] - ctx_r273.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r274.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r275.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r281); const ctx_r280 = ɵngcc0.ɵɵnextContext(); return ctx_r280.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r281); const ctx_r282 = ɵngcc0.ɵɵnextContext(); return ctx_r282.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r281); const ctx_r283 = ɵngcc0.ɵɵnextContext(); return ctx_r283.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r281); const ctx_r284 = ɵngcc0.ɵɵnextContext(); return ctx_r284.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r281); const ctx_r285 = ɵngcc0.ɵɵnextContext(); return ctx_r285.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r276 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r276.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r276.orientation == "horizontal" ? ctx_r276.handleValue + "%" : null, ctx_r276.orientation == "vertical" ? ctx_r276.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r276.tabindex)("aria-valuemin", ctx_r276.min)("aria-valuenow", ctx_r276.value)("aria-valuemax", ctx_r276.max)("aria-labelledby", ctx_r276.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r288); const ctx_r287 = ɵngcc0.ɵɵnextContext(); return ctx_r287.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r288); const ctx_r289 = ɵngcc0.ɵɵnextContext(); return ctx_r289.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r288); const ctx_r290 = ɵngcc0.ɵɵnextContext(); return ctx_r290.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r288); const ctx_r291 = ɵngcc0.ɵɵnextContext(); return ctx_r291.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r288); const ctx_r292 = ɵngcc0.ɵɵnextContext(); return ctx_r292.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r277 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r277.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r277.rangeStartLeft, ctx_r277.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r277.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r277.tabindex)("aria-valuemin", ctx_r277.min)("aria-valuenow", ctx_r277.value ? ctx_r277.value[0] : null)("aria-valuemax", ctx_r277.max)("aria-labelledby", ctx_r277.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r295 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r295); const ctx_r294 = ɵngcc0.ɵɵnextContext(); return ctx_r294.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r295); const ctx_r296 = ɵngcc0.ɵɵnextContext(); return ctx_r296.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r295); const ctx_r297 = ɵngcc0.ɵɵnextContext(); return ctx_r297.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r295); const ctx_r298 = ɵngcc0.ɵɵnextContext(); return ctx_r298.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r295); const ctx_r299 = ɵngcc0.ɵɵnextContext(); return ctx_r299.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r278 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r278.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r278.rangeEndLeft, ctx_r278.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r278.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r278.tabindex)("aria-valuemin", ctx_r278.min)("aria-valuenow", ctx_r278.value ? ctx_r278.value[1] : null)("aria-valuemax", ctx_r278.max)("aria-labelledby", ctx_r278.ariaLabelledBy);
} }
