...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r80.handleValues[0] + "%", ctx_r80.handleValues[1] - ctx_r80.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r81.handleValues[0] + "%", ctx_r81.handleValues[1] - ctx_r81.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r82.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r83.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r89); const ctx_r88 = ɵngcc0.ɵɵnextContext(); return ctx_r88.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r89); const ctx_r90 = ɵngcc0.ɵɵnextContext(); return ctx_r90.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r89); const ctx_r91 = ɵngcc0.ɵɵnextContext(); return ctx_r91.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r89); const ctx_r92 = ɵngcc0.ɵɵnextContext(); return ctx_r92.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r89); const ctx_r93 = ɵngcc0.ɵɵnextContext(); return ctx_r93.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r84 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r84.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r84.orientation == "horizontal" ? ctx_r84.handleValue + "%" : null, ctx_r84.orientation == "vertical" ? ctx_r84.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r84.disabled ? null : ctx_r84.tabindex)("aria-valuemin", ctx_r84.min)("aria-valuenow", ctx_r84.value)("aria-valuemax", ctx_r84.max)("aria-labelledby", ctx_r84.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r95 = ɵngcc0.ɵɵnextContext(); return ctx_r95.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r97 = ɵngcc0.ɵɵnextContext(); return ctx_r97.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r98 = ɵngcc0.ɵɵnextContext(); return ctx_r98.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r99 = ɵngcc0.ɵɵnextContext(); return ctx_r99.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r96); const ctx_r100 = ɵngcc0.ɵɵnextContext(); return ctx_r100.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r85 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r85.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r85.rangeStartLeft, ctx_r85.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r85.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r85.disabled ? null : ctx_r85.tabindex)("aria-valuemin", ctx_r85.min)("aria-valuenow", ctx_r85.value ? ctx_r85.value[0] : null)("aria-valuemax", ctx_r85.max)("aria-labelledby", ctx_r85.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r103 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 7, 9);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r103); const ctx_r102 = ɵngcc0.ɵɵnextContext(); return ctx_r102.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r103); const ctx_r104 = ɵngcc0.ɵɵnextContext(); return ctx_r104.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r103); const ctx_r105 = ɵngcc0.ɵɵnextContext(); return ctx_r105.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r103); const ctx_r106 = ɵngcc0.ɵɵnextContext(); return ctx_r106.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r103); const ctx_r107 = ɵngcc0.ɵɵnextContext(); return ctx_r107.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r86 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r86.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r86.rangeEndLeft, ctx_r86.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r86.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r86.disabled ? null : ctx_r86.tabindex)("aria-valuemin", ctx_r86.min)("aria-valuenow", ctx_r86.value ? ctx_r86.value[1] : null)("aria-valuemax", ctx_r86.max)("aria-labelledby", ctx_r86.ariaLabelledBy);
} }
