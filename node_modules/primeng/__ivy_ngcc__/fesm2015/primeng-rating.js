...
function Rating_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Rating_span_1_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r67); const ctx_r66 = ɵngcc0.ɵɵnextContext(); return ctx_r66.clear($event); })("keydown.enter", function Rating_span_1_Template_span_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r67); const ctx_r68 = ɵngcc0.ɵɵnextContext(); return ctx_r68.clear($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r64 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r64.iconCancelClass)("ngStyle", ctx_r64.iconCancelStyle);
    ɵngcc0.ɵɵattribute("tabindex", ctx_r64.disabled || ctx_r64.readonly ? null : "0");
} }
function Rating_span_2_Template(rf, ctx) { if (rf & 1) {
    const _r72 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 4);
    ɵngcc0.ɵɵlistener("click", function Rating_span_2_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r72); const i_r70 = ctx.index; const ctx_r71 = ɵngcc0.ɵɵnextContext(); return ctx_r71.rate($event, i_r70); })("keydown.enter", function Rating_span_2_Template_span_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r72); const i_r70 = ctx.index; const ctx_r73 = ɵngcc0.ɵɵnextContext(); return ctx_r73.rate($event, i_r70); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const i_r70 = ctx.index;
    const ctx_r65 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", !ctx_r65.value || i_r70 >= ctx_r65.value ? ctx_r65.iconOffClass : ctx_r65.iconOnClass)("ngStyle", !ctx_r65.value || i_r70 >= ctx_r65.value ? ctx_r65.iconOffStyle : ctx_r65.iconOnStyle);
    ɵngcc0.ɵɵattribute("tabindex", ctx_r65.disabled || ctx_r65.readonly ? null : "0");
} }
