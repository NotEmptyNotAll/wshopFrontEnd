...
function ToastItem_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("p-message-icon pi" + (ctx_r762.message.icon ? " " + ctx_r762.message.icon : ""));
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(5, _c1, ctx_r762.message.severity == "info", ctx_r762.message.severity == "warn", ctx_r762.message.severity == "error", ctx_r762.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r762.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r762.message.detail);
} }
function ToastItem_button_4_Template(rf, ctx) { if (rf & 1) {
    const _r766 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 10);
    ɵngcc0.ɵɵlistener("click", function ToastItem_button_4_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r766); const ctx_r765 = ɵngcc0.ɵɵnextContext(); return ctx_r765.onCloseIconClick($event); })("keydown.enter", function ToastItem_button_4_Template_button_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r766); const ctx_r767 = ɵngcc0.ɵɵnextContext(); return ctx_r767.onCloseIconClick($event); });
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r773); const ctx_r772 = ɵngcc0.ɵɵnextContext(); return ctx_r772.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r773); const ctx_r774 = ɵngcc0.ɵɵnextContext(); return ctx_r774.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r770 = ctx.$implicit;
    const i_r771 = ctx.index;
    const ctx_r769 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r770)("index", i_r771)("template", ctx_r769.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r769.showTransformOptions)("hideTransformOptions", ctx_r769.hideTransformOptions)("showTransitionOptions", ctx_r769.showTransitionOptions)("hideTransitionOptions", ctx_r769.hideTransitionOptions);
} }
class ToastItem {
    constructor(zone) {
        this.zone = zone;
