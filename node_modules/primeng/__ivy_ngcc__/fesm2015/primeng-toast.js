...
function ToastItem_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("p-message-icon pi" + (ctx_r360.message.icon ? " " + ctx_r360.message.icon : ""));
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction4(5, _c1, ctx_r360.message.severity == "info", ctx_r360.message.severity == "warn", ctx_r360.message.severity == "error", ctx_r360.message.severity == "success"));
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵtextInterpolate(ctx_r360.message.summary);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r360.message.detail);
} }
function ToastItem_button_4_Template(rf, ctx) { if (rf & 1) {
    const _r364 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 10);
    ɵngcc0.ɵɵlistener("click", function ToastItem_button_4_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r364); const ctx_r363 = ɵngcc0.ɵɵnextContext(); return ctx_r363.onCloseIconClick($event); })("keydown.enter", function ToastItem_button_4_Template_button_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r364); const ctx_r365 = ɵngcc0.ɵɵnextContext(); return ctx_r365.onCloseIconClick($event); });
...
function Toast_p_toastItem_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onClose", function Toast_p_toastItem_2_Template_p_toastItem_onClose_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r371); const ctx_r370 = ɵngcc0.ɵɵnextContext(); return ctx_r370.onMessageClose($event); })("@toastAnimation.start", function Toast_p_toastItem_2_Template_p_toastItem_animation_toastAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r371); const ctx_r372 = ɵngcc0.ɵɵnextContext(); return ctx_r372.onAnimationStart($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const msg_r368 = ctx.$implicit;
    const i_r369 = ctx.index;
    const ctx_r367 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("message", msg_r368)("index", i_r369)("template", ctx_r367.template)("@toastAnimation", undefined)("showTransformOptions", ctx_r367.showTransformOptions)("hideTransformOptions", ctx_r367.hideTransformOptions)("showTransitionOptions", ctx_r367.showTransitionOptions)("hideTransitionOptions", ctx_r367.hideTransitionOptions);
} }
class ToastItem {
    constructor(zone) {
        this.zone = zone;
