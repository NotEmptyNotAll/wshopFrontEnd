...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r307); const ctx_r308 = ɵngcc0.ɵɵnextContext(); const item_r301 = ctx_r308.$implicit; const i_r302 = ctx_r308.index; const ctx_r306 = ɵngcc0.ɵɵnextContext(); return ctx_r306.itemClick($event, item_r301, i_r302); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r307); const ctx_r310 = ɵngcc0.ɵɵnextContext(); const item_r301 = ctx_r310.$implicit; const i_r302 = ctx_r310.index; const ctx_r309 = ɵngcc0.ɵɵnextContext(); return ctx_r309.itemClick($event, item_r301, i_r302); });
    ...
    const item_r301 = ctx_r311.$implicit;
    const i_r302 = ctx_r311.index;
    const ctx_r304 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r301.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r301.target)("id", item_r301.id)("tabindex", item_r301.disabled || i_r302 !== ctx_r304.activeIndex && ctx_r304.readonly ? null : item_r301.tabindex ? item_r301.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r302 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r301.label);
} }
...
function Steps_li_2_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r314 = ɵngcc0.ɵɵnextContext(); const item_r301 = ctx_r314.$implicit; const i_r302 = ctx_r314.index; const ctx_r312 = ɵngcc0.ɵɵnextContext(); return ctx_r312.itemClick($event, item_r301, i_r302); })("keydown.enter", function Steps_li_2_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r313); const ctx_r316 = ɵngcc0.ɵɵnextContext(); const item_r301 = ctx_r316.$implicit; const i_r302 = ctx_r316.index; const ctx_r315 = ɵngcc0.ɵɵnextContext(); return ctx_r315.itemClick($event, item_r301, i_r302); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(3, "span", 9);
    ...
    const item_r301 = ctx_r317.$implicit;
    const i_r302 = ctx_r317.index;
    const ctx_r305 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r301.routerLink)("queryParams", item_r301.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", item_r301.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(15, _c0))("fragment", item_r301.fragment)("queryParamsHandling", item_r301.queryParamsHandling)("preserveFragment", item_r301.preserveFragment)("skipLocationChange", item_r301.skipLocationChange)("replaceUrl", item_r301.replaceUrl)("state", item_r301.state);
    ɵngcc0.ɵɵattribute("target", item_r301.target)("id", item_r301.id)("tabindex", item_r301.disabled || i_r302 !== ctx_r305.activeIndex && ctx_r305.readonly ? null : item_r301.tabindex ? item_r301.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r302 + 1);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(item_r301.label);
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap(item_r301.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", item_r301.style)("ngClass", ɵngcc0.ɵɵpureFunction4(8, _c1, i_r302 === ctx_r300.activeIndex, i_r302 !== ctx_r300.activeIndex, i_r302 < ctx_r300.activeIndex, item_r301.disabled || i_r302 !== ctx_r300.activeIndex && ctx_r300.readonly));
    ɵngcc0.ɵɵattribute("aria-selected", i_r302 === ctx_r300.activeIndex)("aria-expanded", i_r302 === ctx_r300.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !item_r301.routerLink);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r301.routerLink);
} }
