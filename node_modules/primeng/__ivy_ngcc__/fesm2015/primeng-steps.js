...
function Steps_li_2_a_2_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r33 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r33.label);
} }
function Steps_li_2_a_2_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 12);
} if (rf & 2) {
    const item_r33 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵproperty("innerHTML", item_r33.label, ɵngcc0.ɵɵsanitizeHtml);
} }
...
function Steps_li_2_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r45); const ctx_r46 = ɵngcc0.ɵɵnextContext(); const item_r33 = ctx_r46.$implicit; const i_r34 = ctx_r46.index; const ctx_r44 = ɵngcc0.ɵɵnextContext(); return ctx_r44.itemClick($event, item_r33, i_r34); })("keydown.enter", function Steps_li_2_a_2_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r45); const ctx_r48 = ɵngcc0.ɵɵnextContext(); const item_r33 = ctx_r48.$implicit; const i_r34 = ctx_r48.index; const ctx_r47 = ɵngcc0.ɵɵnextContext(); return ctx_r47.itemClick($event, item_r33, i_r34); });
    ...
    const item_r33 = ctx_r49.$implicit;
    const i_r34 = ctx_r49.index;
    const ctx_r36 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("routerLink", item_r33.routerLink)("queryParams", item_r33.queryParams)("routerLinkActive", "p-menuitem-link-active")("routerLinkActiveOptions", item_r33.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(16, _c0))("fragment", item_r33.fragment)("queryParamsHandling", item_r33.queryParamsHandling)("preserveFragment", item_r33.preserveFragment)("skipLocationChange", item_r33.skipLocationChange)("replaceUrl", item_r33.replaceUrl)("state", item_r33.state);
    ɵngcc0.ɵɵattribute("target", item_r33.target)("id", item_r33.id)("tabindex", item_r33.disabled || ctx_r36.readonly ? null : item_r33.tabindex ? item_r33.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r34 + 1);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r33.escape !== false)("ngIfElse", _r40);
} }
...
function Steps_li_2_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Steps_li_2_ng_template_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r56); const ctx_r57 = ɵngcc0.ɵɵnextContext(); const item_r33 = ctx_r57.$implicit; const i_r34 = ctx_r57.index; const ctx_r55 = ɵngcc0.ɵɵnextContext(); return ctx_r55.itemClick($event, item_r33, i_r34); })("keydown.enter", function Steps_li_2_ng_template_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r56); const ctx_r59 = ɵngcc0.ɵɵnextContext(); const item_r33 = ctx_r59.$implicit; const i_r34 = ctx_r59.index; const ctx_r58 = ɵngcc0.ɵɵnextContext(); return ctx_r58.itemClick($event, item_r33, i_r34); });
    ɵngcc0.ɵɵelementStart(1, "span", 8);
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    const _r51 = ɵngcc0.ɵɵreference(5);
    const ctx_r60 = ɵngcc0.ɵɵnextContext();
    const item_r33 = ctx_r60.$implicit;
    const i_r34 = ctx_r60.index;
    const ctx_r38 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵattribute("href", item_r33.url, ɵngcc0.ɵɵsanitizeUrl)("target", item_r33.target)("id", item_r33.id)("tabindex", item_r33.disabled || i_r34 !== ctx_r38.activeIndex && ctx_r38.readonly ? null : item_r33.tabindex ? item_r33.tabindex : "0");
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(i_r34 + 1);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", item_r33.escape !== false)("ngIfElse", _r51);
} }
...
function Steps_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMap(item_r33.styleClass);
    ɵngcc0.ɵɵproperty("ngStyle", item_r33.style)("ngClass", ɵngcc0.ɵɵpureFunction2(8, _c1, ctx_r32.isActive(item_r33, i_r34), item_r33.disabled || ctx_r32.readonly && !ctx_r32.isActive(item_r33, i_r34)));
    ɵngcc0.ɵɵattribute("aria-selected", i_r34 === ctx_r32.activeIndex)("aria-expanded", i_r34 === ctx_r32.activeIndex);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r32.isClickableRouterLink(item_r33))("ngIfElse", _r37);
} }
