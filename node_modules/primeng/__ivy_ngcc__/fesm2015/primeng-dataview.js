...
function DataView_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵclassMap("p-dataview-loading-icon pi-spin " + ctx_r64.loadingIcon);
} }
...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r65.headerTemplate);
} }
function DataView_p_paginator_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_3_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r73); const ctx_r72 = ɵngcc0.ɵɵnextContext(); return ctx_r72.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r66 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r66.rows)("first", ctx_r66.first)("totalRecords", ctx_r66.totalRecords)("pageLinkSize", ctx_r66.pageLinks)("alwaysShow", ctx_r66.alwaysShowPaginator)("rowsPerPageOptions", ctx_r66.rowsPerPageOptions)("dropdownAppendTo", ctx_r66.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r66.paginatorDropdownScrollHeight)("templateLeft", ctx_r66.paginatorLeftTemplate)("templateRight", ctx_r66.paginatorRightTemplate)("currentPageReportTemplate", ctx_r66.currentPageReportTemplate)("showFirstLastIcon", ctx_r66.showFirstLastIcon)("dropdownItemTemplate", ctx_r66.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r66.showCurrentPageReport)("showJumpToPageDropdown", ctx_r66.showJumpToPageDropdown)("showPageLinks", ctx_r66.showPageLinks);
} }
...
function DataView_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r67.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r74, rowIndex_r75));
} }
function DataView_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r68.emptyMessage);
} }
function DataView_p_paginator_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_9_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r78); const ctx_r77 = ɵngcc0.ɵɵnextContext(); return ctx_r77.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r69 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r69.rows)("first", ctx_r69.first)("totalRecords", ctx_r69.totalRecords)("pageLinkSize", ctx_r69.pageLinks)("alwaysShow", ctx_r69.alwaysShowPaginator)("rowsPerPageOptions", ctx_r69.rowsPerPageOptions)("dropdownAppendTo", ctx_r69.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r69.paginatorDropdownScrollHeight)("templateLeft", ctx_r69.paginatorLeftTemplate)("templateRight", ctx_r69.paginatorRightTemplate)("currentPageReportTemplate", ctx_r69.currentPageReportTemplate)("showFirstLastIcon", ctx_r69.showFirstLastIcon)("dropdownItemTemplate", ctx_r69.paginatorDropdownItemTemplate)("showCurrentPageReport", ctx_r69.showCurrentPageReport)("showJumpToPageDropdown", ctx_r69.showJumpToPageDropdown)("showPageLinks", ctx_r69.showPageLinks);
} }
...
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r70.footerTemplate);
} }
...
DataView.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DataView, selectors: [["p-dataView"]], contentQueries: function DataView_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc1.NgClass, ɵngcc1.NgStyle, ɵngcc1.NgIf, ɵngcc1.NgForOf, ɵngcc1.NgTemplateOutlet, ɵngcc2.Paginator], pipes: [ɵngcc1.SlicePipe], styles: [".p-dataview{position:relative}.p-dataview .p-dataview-loading-overlay{align-items:center;display:flex;justify-content:center;position:absolute;z-index:2}"], encapsulation: 2, changeDetection: 0 });
