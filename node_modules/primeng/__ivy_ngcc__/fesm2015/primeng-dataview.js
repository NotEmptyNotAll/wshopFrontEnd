...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r78.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r85); const ctx_r84 = ɵngcc0.ɵɵnextContext(); return ctx_r84.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    const rowIndex_r87 = ctx.index;
    const ctx_r80 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r80.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r86, rowIndex_r87));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r81.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r90); const ctx_r89 = ɵngcc0.ɵɵnextContext(); return ctx_r89.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r82 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r82.rows)("first", ctx_r82.first)("totalRecords", ctx_r82.totalRecords)("pageLinkSize", ctx_r82.pageLinks)("alwaysShow", ctx_r82.alwaysShowPaginator)("rowsPerPageOptions", ctx_r82.rowsPerPageOptions)("dropdownAppendTo", ctx_r82.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r82.paginatorDropdownScrollHeight)("templateLeft", ctx_r82.paginatorLeftTemplate)("templateRight", ctx_r82.paginatorRightTemplate)("currentPageReportTemplate", ctx_r82.currentPageReportTemplate)("showCurrentPageReport", ctx_r82.showCurrentPageReport);
} }
