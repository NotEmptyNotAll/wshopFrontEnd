...
function OrderList_div_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keyup", function OrderList_div_8_Template_input_keyup_2_listener($event) { ɵngcc0.ɵɵrestoreView(_r66); const ctx_r65 = ɵngcc0.ɵɵnextContext(); return ctx_r65.onFilterKeyup($event); });
    ɵngcc0.ɵɵelementEnd();
...
function OrderList_ng_template_11_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function OrderList_ng_template_11_li_0_Template_li_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r74); const i_r68 = ɵngcc0.ɵɵnextContext().index; const ctx_r73 = ɵngcc0.ɵɵnextContext(); return ctx_r73.onDragOver($event, i_r68); })("drop", function OrderList_ng_template_11_li_0_Template_li_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r74); const i_r68 = ɵngcc0.ɵɵnextContext().index; const ctx_r76 = ɵngcc0.ɵɵnextContext(); return ctx_r76.onDrop($event, i_r68); })("dragleave", function OrderList_ng_template_11_li_0_Template_li_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r74); const ctx_r78 = ɵngcc0.ɵɵnextContext(2); return ctx_r78.onDragLeave($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const i_r68 = ɵngcc0.ɵɵnextContext().index;
...
function OrderList_ng_template_11_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(0, "li", 21);
    ɵngcc0.ɵɵlistener("dragover", function OrderList_ng_template_11_li_3_Template_li_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r81); const i_r68 = ɵngcc0.ɵɵnextContext().index; const ctx_r80 = ɵngcc0.ɵɵnextContext(); return ctx_r80.onDragOver($event, i_r68 + 1); })("drop", function OrderList_ng_template_11_li_3_Template_li_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r81); const i_r68 = ɵngcc0.ɵɵnextContext().index; const ctx_r83 = ɵngcc0.ɵɵnextContext(); return ctx_r83.onDrop($event, i_r68 + 1); })("dragleave", function OrderList_ng_template_11_li_3_Template_li_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r81); const ctx_r85 = ɵngcc0.ɵɵnextContext(2); return ctx_r85.onDragLeave($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const i_r68 = ɵngcc0.ɵɵnextContext().index;
...
function OrderList_ng_template_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function OrderList_ng_template_11_Template_li_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r88); const item_r67 = ctx.$implicit; const i_r68 = ctx.index; const ctx_r87 = ɵngcc0.ɵɵnextContext(); return ctx_r87.onItemClick($event, item_r67, i_r68); })("touchend", function OrderList_ng_template_11_Template_li_touchend_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r88); const ctx_r89 = ɵngcc0.ɵɵnextContext(); return ctx_r89.onItemTouchEnd($event); })("keydown", function OrderList_ng_template_11_Template_li_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r88); const item_r67 = ctx.$implicit; const i_r68 = ctx.index; const ctx_r90 = ɵngcc0.ɵɵnextContext(); return ctx_r90.onItemKeydown($event, item_r67, i_r68); })("dragstart", function OrderList_ng_template_11_Template_li_dragstart_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r88); const i_r68 = ctx.index; const ctx_r91 = ɵngcc0.ɵɵnextContext(); return ctx_r91.onDragStart($event, i_r68); })("dragend", function OrderList_ng_template_11_Template_li_dragend_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r88); const ctx_r92 = ɵngcc0.ɵɵnextContext(); return ctx_r92.onDragEnd($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c2, ctx_r64.isSelected(item_r67)));
    ɵngcc0.ɵɵattribute("aria-selected", ctx_r64.isSelected(item_r67))("draggable", ctx_r64.dragdrop);
    ɵngcc0.ɵɵadvance(1);
